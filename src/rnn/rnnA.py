...
def get_data(path, ngram, begin_end_word = True):
    ...
    train_sentences, train_labels = load_ner_data(r'C:\Users\sagar\Dropbox\CourseWork\Structured Prediction\Project\work\rnn code\tagged_text_A\train_data_rnn.txt')
    testa_sentences, testa_labels = load_ner_data(r'C:\Users\sagar\Dropbox\CourseWork\Structured Prediction\Project\work\rnn code\tagged_text_A\test_data_rnn.txt')
    #===========================================================================
